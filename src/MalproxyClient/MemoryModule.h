...
extern "C" {
	typedef std::function<LPVOID(LPVOID, SIZE_T, DWORD, DWORD, void*)> CustomAllocFunc;
	typedef std::function<BOOL(LPVOID, SIZE_T, DWORD, void*)> CustomFreeFunc;
	typedef std::function<HCUSTOMMODULE(LPCSTR, void *)> CustomLoadLibraryFunc;
	typedef std::function<FARPROC(HCUSTOMMODULE, LPCSTR, void *)> CustomGetProcAddressFunc;
	typedef std::function<void(HCUSTOMMODULE, void *)> CustomFreeLibraryFunc;
#else
